...
public:
    ...
    LongNum(const std::string &value) // main constructor
    {
    ...
    LongNum(long long numb) : LongNum(std::to_string(numb)) // constructor for suitable numbers
    {
    }
    LongNum(const LongNum &rhs) = default; // copying mechanism
